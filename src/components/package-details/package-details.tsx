...
export const PackageDetails = ({
  ...
  return (
    ...
    >
      {isEmpty ? (
        <div
          className='flex min-h-[60vh] w-full items-center justify-center text-center text-gray-700 dark:text-gray-400'
        >
          <div>
            <div className='mt-8 text-[16px] font-semibold'>No package selected</div>
            <div className='mt-1 text-[14px]'>Select a package to view its details.</div>
          </div>
        </div>
      ) : (
        <>
